Feature: Collision protection from the box
    ...
    Scenario: Existing file
        ...
        When implemented
        When run ndbam-import --image /tmp/image sci-physics/particles
        Then failure
    ...
    Scenario: Existing directory
        ...
        When implemented
        When run ndbam-import --image /tmp/image sec-policy/wong
        Then failure
    ...
    Scenario: Existing symlink with missing target
        ...
        When implemented
        When run ndbam-import --image /tmp/image sci-misc/el
        Then failure
    ...
    Scenario: Existing symlink to directory
        ...
        When implemented
        When run ndbam-import --image /tmp/image app-misc/answers
        Then failure
