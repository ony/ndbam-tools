Feature: Correctness of symlinks proven before actual install
    ...
    Scenario: Relative symlink that crosses root
        ...
        When implemented
        When run ndbam-import --location /tmp/image virtualization/world
        Then failure
    ...
    Scenario: Absolute symlinks that is valid relative to root
        ...
        When implemented
        When run ndbam-import --location /tmp/image sys-power/club
        Then success
    ...
    Scenario: Dangling symlink
        ...
        When implemented
        When run ndbam-import --location /tmp/image dev-libs/loosy
        Then failure
